...
<form class="form-horizontal" role="form" action="{{url('brand/edit')}}" method="post">
	@csrf
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="brand_source" value="{{$brand->brand_source}}">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="brand_cell" value="{{$brand->brand_cell}}">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="cart_id" value="{{$brand->cart_id}}">
    </div>
  </div>
